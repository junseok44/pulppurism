...
export default function HomeOpinionCard({ opinion, onClick }: HomeOpinionCardProps) {
  ...
  return (
    <>
      <div 
        className="min-w-[240px] w-[240px] bg-white rounded-3xl p-5 flex flex-col justify-between border border-gray-100 hover:border-ok_sand hover:shadow-md transition-all cursor-pointer text-left group"
        onClick={onClick}
      >
        <div className="mb-3">
