    ...
    <div className="space-y-4" data-testid="widget-voting">
      ...
      <div className="w-full flex items-center gap-2.5">
        ...
        >
          ...
          <div className="text-center text-green-700 text-base font-black leading-5">찬성한다</div>
        </div>
        ...
        >
          ...
          <div className="text-center text-amber-500 dark:text-amber-600 text-base font-black leading-5">중립이다</div>
        </div>
        ...
        >
          ...
          <div className="text-center text-red-600 text-base font-black leading-5">반대한다</div>
        </div>
      </div>
      {selectedVote && (
